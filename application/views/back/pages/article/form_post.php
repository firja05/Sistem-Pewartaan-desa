...
<head>
  ...
  <title>Admin - Pewartaan Desa</title>
        ...
        <div class="container">
            ...
            <?= form_open_multipart($form_action) ?>
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     <textarea name="content" rows="4" class="form-control" id="tinymce"><?= $input->content; ?></textarea>
               ...
               <div class="form-group row">
                  <div class="col">
                     <label for="featured" class="col-form-label">Berita Utama</label>
                  ...
                  <div class="col">
                     <label for="choice" class="col-form-label">Berita</label>
               ...
               <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                     ...
                     <small id="fileSizeError" class="form-text text-danger d-none"></small>
               ...
               <button type="submit" class="btn btn-sm btn-primary float-right" id="submitBtn">Simpan</button>
...
<!-- Sertakan TinyMCE dengan API Key -->
<script src="https://cdn.tiny.cloud/1/aqxelszyxeopuiipx5r4ztbrblo4g0tj20pmbcueetucpz0c/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
<script>
   tinymce.init({
      selector: '#tinymce',
      menubar: false,
    ...
    $(document).ready(function() {
        $('#submitBtn').click(function(event) {
            ...
            if (fileInput.files.length > 0) {
                ...
                // Ukuran maksimum dalam bytes (1 MB)
                var maxSize = 1024 * 1024; 

                // Validasi ukuran file
                if (fileSize > maxSize) {
                    $('#fileSizeError').text('Ukuran file melebihi 1MB. Silakan unggah file dengan ukuran maksimum 1MB.');
